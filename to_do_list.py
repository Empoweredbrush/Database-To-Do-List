...
def Start():
    ...
    print("Welcome " + name + ", to begin do you wish to A) add items to your To-Do list, B) Alter an item (update an item), or C) delete or complete an item?")
...
def overwrite():
    ...
    change = input("What would you like to update the task to? Note: This is updating the description of your task, not the task name. ")
    doc_ref.update(change)
